...
def combine_quality_information(agent):
    return Task(
        description="Given a list of code quality reports regarding to software supply chain: {list_of_reports}, "
                    ...
                    "1) combine them together as an overall clear and comprehensive new code quality "
                    "report of software supply chain for this science product tailored for scientists "
                    "who may not be well-versed in security; 2) generate a prompt for following code quality "
                    "repair LLM agent to fix the software supply chain hazard."
                    "!!!Note:\n"
                    ...
                    "Finally, generate a prompt for following code quality repair LLM agent to fix the hazard. "
                    "The prompt should start with 'You are a code quality repair agent to fix the hazard in software "
                    ...
                    "and scientists needs-and-scenario-considered.",
        agent=agent,
        expected_output='A combined report showing overall code quality information for software supply chain and the '
                        'prompt to following LLM agent for code quality fixing.'
    )
